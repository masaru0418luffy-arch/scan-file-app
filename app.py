...
# お客様名・題名・見出しはすべて任意。ただしファイル名が日付だけに
# ならないよう、少なくとも1つは入力してもらう。
if not cust_val.strip() and not ttl_val.strip() and not head_val.strip():
    st.warning("お客様名・題名・見出しのうち、少なくとも1つを入力してください。")
    st.stop()
